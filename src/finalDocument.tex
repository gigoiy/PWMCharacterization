...
\begin{figure}[h]
\includegraphics[scale=.70]{assets/squarewave.png}
\caption{PWM Example}
\end{figure}
...
\begin{figure}[h]
\includegraphics[scale=.70]{assets/harmonics.png}
\caption{Harmonics of the PWM Square Wave}
\end{figure}

\begin{figure}[h]
\includegraphics[scale=.70]{assets/phase.png}
\caption{Phase of the PWM Square Wave}
\end{figure}

\begin{figure}[h]
\includegraphics[scale=.70]{assets/coefficients.png}
